...
table.innerHTML = `     <thead class="bg-gray-200 text-left">       <tr><th class="p-2">Título</th><th class="p-2">Prioridad</th>           <th class="p-2">Fecha Límite</th><th class="p-2">Hora</th>           <th class="p-2">Duración</th><th class="p-2">Subtareas</th>           <th class="p-2">Depende</th>           <th class="p-2">Notas</th></tr>     </thead><tbody class="divide-y"></tbody>`;
...
panel.innerHTML = \` <h2 class="font-semibold mb-2">Nota de “\${task.title}”</h2> <textarea id="note-edit" rows="3"
           class="w-full p-2 border rounded mb-2">\${task.notes}</textarea> <button id="save-note" class="bg-blue-500 text-white px-4 py-2 rounded mb-4">
Guardar nota </button>
